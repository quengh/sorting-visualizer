# Sorting Algorithm Visualizer / 排序算法可视化

[![English](https://img.shields.io/badge/Language-English-blue)](#english)
[![中文](https://img.shields.io/badge/语言-中文-red)](#中文)

A beautiful, interactive web application for visualizing sorting algorithms with bilingual support (Chinese/English). Built with Vite, React, TypeScript, and Tailwind CSS.

一个美观的交互式排序算法可视化 Web 应用，支持中英文双语。使用 Vite、React、TypeScript 和 Tailwind CSS 构建。
